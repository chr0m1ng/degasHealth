...
//            assertEquals("ERRO! Caracter '%' Invalido!", res);
//
//            res = facade.novoEnfermeiro("F�bio  J#nior","M","151329","Br@sil","28/05/1962","23/03/1992","28/12/1988");
//            assertEquals("ERRO! Caracter '#' Invalido!", res);
//
//            res = facade.novoEnfermeiro("Geremilda  L@jot#","F","151329","Brasil","18/05/1962","22/07/1992","18/11/1988");
//            assertEquals("ERRO! Caracter '@' Invalido!", res);
//
//            res = facade.novoEnfermeiro("Hor�clides da Hora Certa","M","151329","Brasil","28/05/1962","22/07/1992","18/11/1988");
//            assertEquals("Enfermeiro inserido!", res);
//
//            res = facade.novoEnfermeiro("�talo  Pinto Vloger","M","151329","Brasil","28/05/1962","22/7/1992","18/11/1988");
//            assertEquals("ERRO! COREN J� existente!", res);
//
...
//            assertEquals("ERRO! Inconsistencia de datas: Formatura posterior a admiss�o!", res);
//
//            res = facade.novoEnfermeiro("B�tima da Silva Sauro","F","189673","Brasil","12/02/1984","31/05/2013","05/07/2011");
//            assertEquals("Enfermeiro inserido!", res);
//
...
//            assertEquals("Hor�clides  da Hora Certa%M%151329%Brasil%28/05/1962%22/07/1992%18/11/1988", res);
//
//            /*-----------------Mais testes ap�s nova persist�ncia-----------------------------*/
//
//            facade = new Facade();
...
//            assertEquals("Alteracao executada com sucesso!", res);
//            res = facade.encontraEnfermeiro("151329");
//            assertEquals("Hor�clides da Hora Certa%F%151329%Brasil%28/05/1962%22/07/1992%18/11/1988", res);
//
...
//            assertEquals("B�tima da Silva Sauro%F%189673%Brasil%12/02/1984%31/05/2013%30/03/2010", res);
//
...
//            assertEquals("Auxiliar/T�cnico inserido!", res);
//
//            res = facade.novoAuxiliar("B�rbara%  Leonel","F","251329","Brasil","18/10/1971","22/01/1999","18/05/1990");
//            assertEquals("ERRO! Caracter '%' Invalido!", res);
//
//            res = facade.novoAuxiliar("C�charpe L#dligues","M","251329","Brasil","28/11/1961","22/01/1992","18/05/1988");
//            assertEquals("ERRO! Caracter '#' Invalido!", res);
//
...
//            assertEquals("ERRO! Caracter '%' Invalido!", res);
//
//            res = facade.novoAuxiliar("Fab�ola do C#menor","M","251329","Br@sil","28/11/1961","23/09/1991","28/08/1988");
//            assertEquals("ERRO! Caracter '#' Invalido!", res);
//
//            res = facade.novoAuxiliar("Galinda C@xaqt#","F","251329","Brasil","18/11/1962","22/01/1992","18/05/1988");
//            assertEquals("ERRO! Caracter '@' Invalido!", res);
//
//            res = facade.novoAuxiliar("Hermit�o da Gruta Longe","M","251329","Brasil","28/11/1962","22/01/1992","18/05/1988");
//            assertEquals("Auxiliar/T�cnico inserido!", res);
//
...
//            facade = new Facade();
//
//            res = facade.novoAuxiliar("Naiara Cinquenta","F","21566","Tch�quia","07/10/1988","28/09/2016","22/06/2012");
//            assertEquals("Auxiliar/T�cnico inserido!", res);
//
//            res = facade.novoAuxiliar("Olimpo Luz do Pante�o Divino ","M","21566","Brasil","05/12/1989","28/03/2017","22/06/2012");
//            assertEquals("ERRO! COREN J� existente!", res);
//
//            res = facade.novoAuxiliar("Pablo Bardo da Sofr�ncia Bo�mio","M","289673","Brasil","12/10/1984","31/10/2013","05/01/2011");
//            assertEquals("ERRO! Data Inv�lida!", res);
//
...
//            assertEquals("ERRO! Inconsistencia de datas: Formatura posterior a admiss�o!", res);
//
//            res = facade.novoAuxiliar("S�bado de Sol Silva","M","289673","Brasil","12/08/1984","30/11/2013","05/01/2011");
//            assertEquals("Auxiliar/T�cnico inserido!", res);
//
...
//            assertEquals("Hermit�o da Gruta Longe%M%251329%Brasil%28/11/1962%22/01/1992%18/05/1988", res);
//
//            /*-----------------Mais testes ap�s nova persist�ncia-----------------------------*/
//
//            facade = new Facade();
//
//            res = facade.alteraAuxiliar("297719","Nome", "Arsenio Pereira da Produ��o Eficaz");
//            assertEquals("Alteracao executada com sucesso!", res);
//            res = facade.encontraAuxiliar("297719");
//            assertEquals("Arsenio Pereira da Produ��o Eficaz%M%297719%Brasil%24/02/1969%29/12/2016%28/06/2015", res);
//
//            res = facade.alteraAuxiliar("251329","Sexo", "F");
//            assertEquals("Alteracao executada com sucesso!", res);
//            res = facade.encontraAuxiliar("251329");
//            assertEquals("Hermit�o da Gruta Longe%F%251329%Brasil%28/11/1962%22/01/1992%18/05/1988", res);
//
...
//            assertEquals("Naiara Cinquenta%F%21566%Tch�quia%07/10/1988%19/07/2015%22/06/2012", res);
//
...
//            assertEquals("S�bado de Sol Silva%M%289673%Brasil%12/08/1984%30/11/2013%05/01/2011", res);
//
///*-------------------------Procedimentos --------------------------------------------*/
//
